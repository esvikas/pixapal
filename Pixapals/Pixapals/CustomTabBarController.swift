...
class CustomTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        tabBar.selectionIndicatorImage = UIImage.imageWithColor(UIColor(red: 131/255, green: 166/255, blue: 72/255, alpha: 1), size: tabBarItemSize).resizableImageWithCapInsets(UIEdgeInsetsZero)
