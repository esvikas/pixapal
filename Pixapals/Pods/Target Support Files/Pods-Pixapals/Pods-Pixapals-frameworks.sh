...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Pixapals/FBSDKShareKit.framework"
  ...
  install_framework "Pods-Pixapals/OAuthSwift.framework"
  install_framework "Pods-Pixapals/ObjectMapper.framework"
  install_framework "Pods-Pixapals/SevenSwitch.framework"
